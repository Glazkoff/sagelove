    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Мужской'), ('F', 'Женский'), ('NS', 'Не указан')], max_length=20, verbose_name='Пол')),
                ('date_of_birth', models.DateField(blank=True, null=True, verbose_name='Дата рождения')),
                ('phone_number', models.CharField(max_length=30, verbose_name='Номер телефона')),
                ('about_me', models.TextField(verbose_name='О себе')),
                ('photoURL', models.URLField(blank=True, null=True, verbose_name='Фото')),
